	  ...
	  <div class="container">
	    ...
	    <div class="row">
	      <div class="col-md-6">
	        ...
	        <p>Questa funzionalita  realtiva alla Gestione dei Contribuenti</p>
	        <p><a class="btn btn-primary" href="${pageContext.request.contextPath}/contribuente/search" role="button">Vai alla Funzionalita &raquo;</a></p>
	      </div>
	      <div class="col-md-6">
