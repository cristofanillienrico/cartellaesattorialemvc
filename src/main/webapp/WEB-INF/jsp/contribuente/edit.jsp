...
<main role="main" class="container">
    ...
    <spring:hasBindErrors name="modifica_contribuente_attr">
        <%-- alert errori --%>
    ...
    <div class='card'>
        ...
        <div class='card-body'>
            ...
            <form:form modelAttribute="modifica_contribuente_attr" method="post" action="executeedit"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="nome">
                            <input type="text" name="nome" id="nome"
                                   ...
                                   placeholder="Inserire il nome" value="${modifica_contribuente_attr.nome }" required>
                        </spring:bind>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="cognome">
                            <input type="text" name="cognome" id="cognome"
                                   class="form-control ${status.error ? 'is-invalid' : ''}"
                                   placeholder="Inserire il cognome" value="${modifica_contribuente_attr.cognome }"
                                   required>
                        </spring:bind>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="indirizzo">
                            <input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="indirizzo"
                                   id="indirizzo" placeholder="Inserire l' indirizzo"
                                   value="${modifica_contribuente_attr.indirizzo }" required>
                        </spring:bind>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="codiceFiscale">
                            <input type="text" class="form-control ${status.error ? 'is-invalid' : ''}"
                                   name="codiceFiscale" id="codiceFiscale" placeholder="Inserire il codice Fiscale"
                                   value="${modifica_contribuente_attr.codiceFiscale }" required>
                        </spring:bind>
                        <form:errors path="codiceFiscale" cssClass="error_field"/>
                    </div>

                    <fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date'
                                    value='${modifica_contribuente_attr.dataDiNascita}'/>
                ...
                <input type="hidden" name="id" value="${modifica_contribuente_attr.id }">
