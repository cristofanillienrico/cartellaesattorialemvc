                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="nome">
                            <input type="text" name="nome" id="nome"
                                   ...
                                   placeholder="Inserire il nome" value="${insert_contribuente_attr.nome }" required>
                        </spring:bind>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="cognome">
                            <input type="text" name="cognome" id="cognome"
                                   class="form-control ${status.error ? 'is-invalid' : ''}"
                                   placeholder="Inserire il cognome" value="${insert_contribuente_attr.cognome }"
                                   required>
                        </spring:bind>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="codiceFiscale">
                            <input type="text" class="form-control ${status.error ? 'is-invalid' : ''}"
                                   name="codiceFiscale"
                                   id="codiceFiscale" placeholder="Inserire il codice fiscale"
                                   value="${insert_contribuente_attr.codiceFiscale }" required>
                        </spring:bind>
