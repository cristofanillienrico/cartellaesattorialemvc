    ...
    <div class='card'>
        <div class='card'>
            ...
            <div class='card-body'>
                ...
                <form:form method="post" modelAttribute="update_cartellaEsattoriale_attr" action="saveupdate"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="descrizione">
                            <input type="text" name="descrizione" id="descrizione"
                                   ...
                                   value="${update_cartellaEsattoriale_attr.descrizione }">
                        </spring:bind>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="importo">
                            <input type="text" name="importo" id="importo"
                                   class="form-control ${status.error ? 'is-invalid' : ''}"
                                   placeholder="Inserire il importo"
                                   value="${update_cartellaEsattoriale_attr.importo }">
                        </spring:bind>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <spring:bind path="contribuente.id">
                            <input class="form-control ${status.error ? 'is-invalid' : ''}" type="text"
                                   ...
                                   value="${update_cartellaEsattoriale_attr.contribuente.nome}${empty update_cartellaEsattoriale_attr.contribuente.nome?'':' '}${update_cartellaEsattoriale_attr.contribuente.cognome}">
                        </spring:bind>
                        <input type="hidden" name="contribuente" id="contribuenteId"
                               value="${update_cartellaEsattoriale_attr.contribuente.id }">
                        <form:errors path="contribuente" cssClass="error_field"/>
                    </div>

                    <input type="hidden" id="stato" name="stato" value="${update_cartellaEsattoriale_attr.stato}">
                    <input type="hidden" id="id" name="id" value="${update_cartellaEsattoriale_attr.id}">
                ...
                <div class="form-row">
                    ...
                    <button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary">Conferma
                    </button>
